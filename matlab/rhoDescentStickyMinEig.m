...
%the smallest eigenvalue and plots as fn of rho. 
...
rho=50; rho_end=30;  draw=0; eigTol=-1e-6; Etol=1e-14; %Define parameters
...
x=linspace(rho_end,50,length(q));
q=q(end:-1:1);
plot(x,q)
