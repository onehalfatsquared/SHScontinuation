function [b,Pout,Qout,rmsd,L1diff,minDist]=testSameNoPerm(c1,c2,arg3)
    ...
    if arg3==0
        ...
        potTol=1e-5; distTol=1e-4; sameTol=5e-4; gapTol=.1; %Tolerances
    end
    ...
    if arg3==1
        ...
        potTol=Inf; distTol=Inf; sameTol=5e-4; gapTol=1; %Tolerances
    end
